...
public interface ContentsMapper {
    ...
    void addOrUpdate(@Param("articleTitle")String articleTitle, @Param("articleContentHtml")String articleContentHtml, @Param("articleAbstract")String articleAbstract, @Param("articleContentMd")String articleContentMd, @Param("articleCover")String articleCover, @Param("articleDate") Date articleDate);
