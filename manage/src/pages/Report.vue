...
<div style="margin: 20px 20px 0 20px">
  ...
  <el-dialog
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button  type="warning" @click="dialogVisible = false" v-on:click="dispose()">删除</el-button>
  ...
  <el-table-column label="操作">
    <template slot-scope="scope">
      <el-button
                 size="mini"
                 type="warning"
                 @click="dialogVisible=true;getreported_content(scope.row.reported_content);getID(scope.row.id)">查看详情</el-button>
