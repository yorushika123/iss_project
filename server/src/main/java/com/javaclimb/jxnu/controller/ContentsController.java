...
@RequestMapping(value = "/user/write/article",method = RequestMethod.POST)
 ...
 /*   Date date =new Date();
  ...
  /*  int contents_id =contentsMapper.selectID(contents.getArticleTitle(), contents.getArticleContentHtml(), contents.getArticleContentMd());
    ...
    if(contents2==null){
    contentsMapper.addOrUpdate(contents.getArticleTitle(), contents.getArticleContentHtml(), contents.getArticleAbstract(), contents.getArticleContentMd(),contents.getArticleCover(),contents.getArticleDate());
